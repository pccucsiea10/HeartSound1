...
import com.example.heartsound.fragment.StartDepartment3;
import com.example.heartsound.fragment.StartDepartment3_1;
import com.example.heartsound.fragment.StartDepartment3_2;
import com.example.heartsound.fragment.StartDepartment3_3;
import com.example.heartsound.fragment.StartDepartment3_4;
import com.example.heartsound.fragment.StartDepartment3_5;
import com.example.heartsound.fragment.StartDepartment3_6;
import com.example.heartsound.fragment.StartDepartment3_7;
import com.example.heartsound.fragment.StartDepartment3_8;
import com.example.heartsound.fragment.StartDepartment3_9;
...
//        });
        ...
        ElasticRestClient.get("hh2/_search?q=subject:土木與建築群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:化工群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:商業與管理群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:設計群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:農業群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:家政與餐旅群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:外語群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:藝術群測量&size=100", params, new JsonHttpResponseHandler());
        ElasticRestClient.get("hh2/_search?q=subject:醫學與醫護群測量&size=100", params, new JsonHttpResponseHandler());
